...
static constexpr auto qt_meta_stringdata_ZN12FilterDialogE = QtMocHelpers::stringData(
    "FilterDialog",
    "addFilter",
    "",
    "clearFilters"
...
Q_CONSTINIT static const uint qt_meta_data_ZN12FilterDialogE[] = {
...
Q_CONSTINIT const QMetaObject FilterDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12FilterDialogE.offsetsAndSizes,
    qt_meta_data_ZN12FilterDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12FilterDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *FilterDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12FilterDialogE.stringdata0))
