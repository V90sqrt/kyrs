...
static constexpr auto qt_meta_stringdata_ZN15BuyerControllerE = QtMocHelpers::stringData(
    "BuyerController"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15BuyerControllerE[] = {
...
Q_CONSTINIT const QMetaObject BuyerController::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15BuyerControllerE.offsetsAndSizes,
    qt_meta_data_ZN15BuyerControllerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15BuyerControllerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<BuyerController, std::true_type>
    >,
    nullptr
} };
...
void *BuyerController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15BuyerControllerE.stringdata0))
